...
struct ResourceDisclosureTests {
    ...
    @Test("approved inspect exposes only registered inventory metadata")
    func approvedInspect() async throws {
        ...
        #expect(
            reply.details?.metadata.map(\.key) == [
        ...
        let resource = Resource(
            ...
            metadata: [
                ...
                try! ResourceMetadataEntry(
                    ...
                    value: .text("synthetic-private-extension")
                ),
            ],
